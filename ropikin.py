...
def generate_filename():
    """Generate a filename with the pattern a_b_c.d."""
    a_options = [
    ...
    d_options = ["fbx", "psd", "ai", "ae", "uasset"]
...
def generate_commit_message():
    ...
    b_options = ["Building", "Hall", "Tree", "Proops", "Lighting", "Ground", "Environment", 
...
# Main logic to commit 2 times per week in 2 different days
if __name__ == "__main__":
    ...
    while current_date <= end_date:
        for _ in range(2):  # Commit 2 times per week on 2 different days
